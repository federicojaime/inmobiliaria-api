...
$app->add(new \Tuupola\Middleware\JwtAuthentication([
    "ignore" => [
        ...
        "/" . basename(dirname($_SERVER["PHP_SELF"])) . "/properties/public",
        "/" . basename(dirname($_SERVER["PHP_SELF"])) . "/property/public",
        "/" . basename(dirname($_SERVER["PHP_SELF"])) . "/property-types",
        "/" . basename(dirname($_SERVER["PHP_SELF"])) . "/property-types/active",
    ],
